...
#set init_top_cell RISCV_CPU
#set init_verilog ../netlist/RISCV_CPU.v
...
timeDesign -postRoute -pathReports -drvReports -slackReports -numPaths 50 -prefix RISCV_CPU_postRoute -outDir timingReports
redirect -quiet {set honorDomain [getAnalysisMode -honorClockDomains]} > /dev/null
timeDesign -postRoute -hold -pathReports -slackReports -numPaths 50 -prefix RISCV_CPU_postRoute -outDir timingReports
...
reportGateCount -level 5 -limit 100 -outfile ../report/RISCV_CPU_area_ppr.rpt
saveNetlist RISCV_CPU.v
all_hold_analysis_views 
all_setup_analysis_views 
write_sdf  -ideal_clock_network RISCV_CPU.sdf
