...
proc synth {entity architecture analyze option arch_mul} {
	...
	if {$slack >= 0} {	
		#all reports
		report_resources > ../report/$entity\_resources\_$postfix.txt
		report_timing > ../report/$entity\_timing\_$postfix.txt
		report_area > ../report/$entity\_area\_$postfix.txt

		#Printing netlist in verilog	
		change_names -hierarchy -rules verilog

		#netlist files
		write_sdf ../netlist/$entity\_$postfix.sdf
		write -f verilog -hierarchy -output ../netlist/$entity\_$postfix.v
		write_sdc ../netlist/$entity\_$postfix.sdc
	}
	return 0
}
